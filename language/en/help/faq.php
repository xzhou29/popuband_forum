...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_BLOCK_ABOUT_FORUM'	=> 'About This Forum',
	...
	'HELP_FAQ_BLOCK_HADWARE'	=> 'Hardware',
	'HELP_FAQ_BLOCK_POPULELE_SMART_QUESTION'	=> 'How is Populele "smart"?',
	'HELP_FAQ_BLOCK_POPULELE_SMART_ANSWER'	=> "Populele's 72-LED fretboard connects with the app via Bluetooth to show exactly how to play your favorite songs, giving beginners a quick and satisfying way to start their musical journey, and helping the experienced take their repertoire to the next level.",
	'HELP_FAQ_BLOCK_POPULELE_REAL_QUESTION'	=> 'Is Populele a real ukulele without the LED?',
	'HELP_FAQ_BLOCK_POPULELE_REAL_ANSWER'	=> 'Yes. Without the app and LED, Populele is still a premium ukulele with high quality sound.',
	'HELP_FAQ_BLOCK_POPULELE_MATERIAL_QUESTION'	=> 'What kind of material is Populele made of?',
	'HELP_FAQ_BLOCK_POPULELE_MATERIAL_ANSWER'	=> 'Premium European maple, first class spruce, and Italian Aquila strings.',
	'HELP_FAQ_BLOCK_POPULELE_WEIGHT_QUESTION'	=> 'How much does Populele weigh and what is the size?',
	'HELP_FAQ_BLOCK_POPULELE_WEIGHT_ANSWER'	=> 'Populele weights 0.5 KG (1.1 Lbs). The size is : 24 * 8 * 2-3/4 (inches). It’s small and light enough to  fit in your carry-on or backpack.',
	'HELP_FAQ_BLOCK_POPULELE_BATTERY_QUESTION'	=> 'Does Populele need battery? ',
	'HELP_FAQ_BLOCK_POPULELE_BATTERY_ANSWER'	=> 'A rechargeable lithium battery is included in the Populele. The battery can be recharged via the USB port. ',
	'HELP_FAQ_BLOCK_POPULELE_CHARGE_QUESTION'	=> 'How to Charge Populele?',
	'HELP_FAQ_BLOCK_POPULELE_CHARGE_ANSWER'	=> '1.Populele can be charged by regular smart phone adapters with USB to Micro USB cable. <br> 2.Connect the USB charging cable to the charging port on the left side of Populele. <br> 3.The LEDs on the last fretboard will light up and indicate the progress of charging from left to right  (the more LEDs light up, the fuller the battery). <br> 4.Once the battery is fully charged, the 4 LEDs will not light up anymore  (It usually takes about 3 hours to fully charge)',
	'HELP_FAQ_BLOCK_POPULELE_BATTERYLIFE_QUESTION'	=> "How long does the Populele last once it's fully charged?",
	'HELP_FAQ_BLOCK_POPULELE_BATTERYLIFE_ANSWER'	=> 'Populele would last for about 10 hours after fully charged.',
	'HELP_FAQ_BLOCK_POPULELE_ACCESSORIES_PACKAGE_QUESTION'	=> 'What comes with the package if I didn’t order the accessories package during the Indiegogo crowdfunding? ',
	'HELP_FAQ_BLOCK_POPULELE_ACCESSORIES_PACKAGE_ANSWER'	=> 'You will receive your Populele and an USB cable in a beautifully designed box. We don’t include the adapter but any USB power adapter comes along with your phone should work. ',
	'HELP_FAQ_BLOCK_POPULELE_LEDCOLOR_QUESTION'	=> 'Does the LED lights have only one color?',
	'HELP_FAQ_BLOCK_POPULELE_LEDCOLOR_ANSWER'	=> 'Currently, the Populele LED has only one color, but we will add more in the future.',
	'HELP_FAQ_BLOCK_POPULELE_BLUETOOTH_SPEAKER_QUESTION'	=> 'Will the uke be able to connect directly to Bluetooth speakers or amplifiers?
',
	'HELP_FAQ_BLOCK_POPULELE_BLUETOOTH_SPEAKER_ANSWER'	=> 'Unfortunately, Populele is not able to connect to any kinds of speakers. Bluetooth will only be used to connect the APP. 
',


	'HELP_FAQ_BLOCK_APP'	=> 'APP',
	'HELP_FAQ_BLOCK_APP_Bluetooth_QUESTION'	=> "Why can't I connect to Bluetooth?",
	'HELP_FAQ_BLOCK_APP_Bluetooth_ANSWER'	=> "1. Please make sure that your Populele is turned on. Press and hold the power button for 4-5 seconds to turn on Populele. Please open the App to connect Bluetooth after the blue light on the control box lights up.<br> 2. You can press the button to see the battery status of your Populele, and if there's only one LED flashing, you should recharge. <br> 3. Bluetooth connection is completed through the App rather than the Bluetooth section in Settings in your phone.
",
	'HELP_FAQ_BLOCK_APP_recognize_QUESTION'	=> "Why doesn't the App accurately recognize my playing?",
	'HELP_FAQ_BLOCK_APP_recognize_ANSWER'	=> '1. Make sure that you have tuned you Populele before playing.<br> 2. Voice recognition is performed by the element in your phone. If your background music is too loud, we suggest you find a better place to play Populele.
',
	'HELP_FAQ_BLOCK_APP_Playing_QUESTION'	=> "Why doesn't the App know I'm playing?",
	'HELP_FAQ_BLOCK_APP_Playing_ANSWER'	=> "1. If it's iPhone, go to Settings and find Populele. Please make sure Microphone option is allowed.<br> 2. If it's an Android phone, go to Settings and see if the option to allow App to record is turned on.
",
	'HELP_FAQ_BLOCK_APP_Android_QUESTION'	=> 'Is the APP compatible with Android system?',
	'HELP_FAQ_BLOCK_APP_Android_ANSWER'	=> 'The APP will be compatible with both Android and iOS system.',
	'HELP_FAQ_BLOCK_APP_Download_QUESTION'	=> 'When can I download the App?',
	'HELP_FAQ_BLOCK_APP_Download_ANSWER'	=> 'You should be able to download the app through Apple’s App Store and Android’s Google Play by July.',
	'HELP_FAQ_BLOCK_APP_Song_QUESTION'	=> 'Are the songs in the app free or do we have to pay for each song?',
	'HELP_FAQ_BLOCK_APP_Song_ANSWER'	=> 'All songs are free and unlocked when you have your Populele connected to the app.',
	'HELP_FAQ_BLOCK_APP_Programmer_QUESTION'	=> 'Will it be possible for programmers to contribute songs or program the populele?',
	'HELP_FAQ_BLOCK_APP_Programmer_ANSWER'	=> 'Unfortunately, the app does not support users to edit or program songs for now. We will certainly take that into consideration for future development.',
	'HELP_FAQ_BLOCK_APP_Dazzle_QUESTION'	=> 'How does the Dazzle Mode work?',
	'HELP_FAQ_BLOCK_APP_Dazzle_ANSWER'	=> 'The Dazzle mode is for fun! It’s sound responsive totally dependent on the volume. ',

	'HELP_FAQ_BLOCK_ORDERS'	=> 'ORDERS',

	'HELP_FAQ_BLOCK_APP_shippingcountry_QUESTION'	=> 'Do you ship worldwide?',
	'HELP_FAQ_BLOCK_APP_shippingcountry_ANSWER'	=> 'We currently only ship to the US and Canada due to battery shipping regulations. More countries will be covered later.',

	'HELP_FAQ_BLOCK_APP_receive_QUESTION'	=> 'When will I receive my Populele?',
	'HELP_FAQ_BLOCK_APP_receive_ANSWER'	=> 'The first batch will be shipped out before the end of July. Production is running in full capacity beginning late April.',

	'HELP_FAQ_BLOCK_APP_indiegogoAP_QUESTION'	=> 'How can I order Populele and Accessory Package together during the Indiegogo campaign?',
	'HELP_FAQ_BLOCK_APP_indiegogoAP_ANSWER'	=> 'Since we may not be able to have both Populele and Accessory Package all ready at a same time, two different orders are recommended. However, all backers who order both Populele and Accessory Package will be asked whether they prefer to wait to receive two orders together, and we will refund the extra shipping cost.',

	'HELP_FAQ_BLOCK_APP_shopifypayment_QUESTION'	=> 'In what method does the payment get back to me on Shopify?',
	'HELP_FAQ_BLOCK_APP_shopifypayment_ANSWER'	=> 'Depend on the method your choose to purchase, the refund usually takes 5 to 10 days to your original account.',

	'HELP_FAQ_BLOCK_APP_forms_QUESTION'	=> 'What forms of payment do you accept?',
	'HELP_FAQ_BLOCK_APP_forms_ANSWER'	=> 'We currently selling on Shopify and it accepts payments from checking and savings accounts and Visa, ® MasterCard,® Discover, American Express® credit cards and PayPal.',

	
	'HELP_FAQ_BLOCK_WARRANTY'	=> 'Warranty/Returns',

	'HELP_FAQ_BLOCK_APP_warranty_QUESTION'	=> 'Do you offer any warranty?',
	'HELP_FAQ_BLOCK_APP_warranty_ANSWER'	=> 'We are committed to providing you with the best user experience so we offer a one-year warranty. Please read the Warranty section in your Populele Owner’s Manual for detailed explanation. ',

	'HELP_FAQ_BLOCK_APP_refundIndiegogo_QUESTION'	=> 'Can I refund during the Indiegogo crowdfunding campaign?',

	'HELP_FAQ_BLOCK_APP_refundIndiegogo_ANSWER'	=> 'During the campaign, you can process the refund at any time by following the instruction <a style="color: red" href="https://support.indiegogo.com/hc/en-us/articles/526876-Refunds">here</a>. However, refunds are processed on a case-by-case basis; at some points we will need to lock refunds in order to go into production & shipment stage. We will not be able to refund once the orders are shipped.',

	'HELP_FAQ_BLOCK_APP_returnPolicy_QUESTION'	=> 'What’s your return policy?',
	'HELP_FAQ_BLOCK_APP_returnPolicy_ANSWER'	=> 'You have 30 calendar days to return from the date you have received it, verified by tracking information. Please read the Return Policy in your Populele Owner’s Manual for detailed description. ',

	'HELP_FAQ_BLOCK_Others'	=> 'Others',
	'HELP_FAQ_BLOCK_APP_version_QUESTION'	=> 'Does Populele have a left handed version?',
	'HELP_FAQ_BLOCK_APP_version_ANSWER'	=> 'We are currently working on the left handed version and trying to bring it to the market asap, your patience and understanding are appreciated. We will keep updating everyone and provide equal discount chances.',

	'HELP_FAQ_BLOCK_APP_environment_QUESTION'	=> 'Can the Populele be used in any music education environment? ',
	'HELP_FAQ_BLOCK_APP_environment_ANSWER'	=> "Yes! The Populele is a great classroom tool for ukulele and general music teachers. We are also attempting to bring music to some groups with special needs and summer camps children's music learning. ",

	'HELP_FAQ_BLOCK_APP_guitarversion_QUESTION'	=> 'Do you have guitar version?',
	'HELP_FAQ_BLOCK_APP_guitarversion_ANSWER'	=> 'We are currently working the development of the guitar version, and trying to bring it the market later. Please sign up on our official website: www.popuband.com to receive latest updates.',
	...
	'HELP_FAQ_CONTACT_BOARD_QUESTION' => 'How to contact board administrator?',
	'HELP_FAQ_CONTACT_BOARD_ANSWER' => 'Click this <a href="https://forum.popubandmusic.com/memberlist.php?mode=contactadmin">link</a> to send email to board administrator.',
