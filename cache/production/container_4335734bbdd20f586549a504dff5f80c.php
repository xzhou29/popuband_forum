...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        $instance = new \pico\reputation\notification\type\rate_post_negative($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb_user_notifications', $this->get('cache.driver'), $this->get('config'), 'phpbb_notification_types', 'phpbb_notifications');

        $instance->set_controller_helper($this->get('controller.helper'));
        $instance->set_user_loader($this->get('user_loader'));
    ...
    {
        $instance = new \pico\reputation\notification\type\rate_post_positive($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb_user_notifications', $this->get('cache.driver'), $this->get('config'), 'phpbb_notification_types', 'phpbb_notifications');
    ...
    {
        $instance = new \pico\reputation\notification\type\rate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'phpbb_user_notifications', $this->get('cache.driver'), $this->get('config'), 'phpbb_notification_types', 'phpbb_notifications');
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007940ace7000000006f42d659(
...
class phpbbtemplatetwiglexer_000000007940ace7000000006f42d659 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder594ae0710d96d046356427 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer594ae0710d98b154280587 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties594ae0710d917726993652 = array(
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, 'set_environment', array('env' => $env), $this->initializer594ae0710d98b154280587);

        return $this->valueHolder594ae0710d96d046356427->set_environment($env);
    }
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer594ae0710d98b154280587);

        return $this->valueHolder594ae0710d96d046356427->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer594ae0710d98b154280587);

        return $this->valueHolder594ae0710d96d046356427->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer594ae0710d98b154280587 = $initializer;
    }
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, '__get', array('name' => $name), $this->initializer594ae0710d98b154280587);

        if (isset(self::$publicProperties594ae0710d917726993652[$name])) {
            return $this->valueHolder594ae0710d96d046356427->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder594ae0710d96d046356427;
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer594ae0710d98b154280587);
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, '__isset', array('name' => $name), $this->initializer594ae0710d98b154280587);
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, '__unset', array('name' => $name), $this->initializer594ae0710d98b154280587);
    ...
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, '__clone', array(), $this->initializer594ae0710d98b154280587);

        $this->valueHolder594ae0710d96d046356427 = clone $this->valueHolder594ae0710d96d046356427;
    }

    public function __sleep()
    {
        $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, '__sleep', array(), $this->initializer594ae0710d98b154280587);

        return array('valueHolder594ae0710d96d046356427');
    }
    ...
    {
        return $this->initializer594ae0710d98b154280587;
    }
    ...
    {
        return $this->initializer594ae0710d98b154280587 && $this->initializer594ae0710d98b154280587->__invoke($this->valueHolder594ae0710d96d046356427, $this, 'initializeProxy', array(), $this->initializer594ae0710d98b154280587);
    }
    ...
    {
        return null !== $this->valueHolder594ae0710d96d046356427;
    }
    ...
    {
        return $this->valueHolder594ae0710d96d046356427;
    }
