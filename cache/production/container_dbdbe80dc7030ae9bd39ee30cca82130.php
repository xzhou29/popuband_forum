...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000702c7b63000000004c2fb60d(
...
class phpbbtemplatetwiglexer_00000000702c7b63000000004c2fb60d extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder594adff7df2f3576042263 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer594adff7df321397626846 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties594adff7df277333953379 = array(
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, 'set_environment', array('env' => $env), $this->initializer594adff7df321397626846);

        return $this->valueHolder594adff7df2f3576042263->set_environment($env);
    }
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer594adff7df321397626846);

        return $this->valueHolder594adff7df2f3576042263->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer594adff7df321397626846);

        return $this->valueHolder594adff7df2f3576042263->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer594adff7df321397626846 = $initializer;
    }
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, '__get', array('name' => $name), $this->initializer594adff7df321397626846);

        if (isset(self::$publicProperties594adff7df277333953379[$name])) {
            return $this->valueHolder594adff7df2f3576042263->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder594adff7df2f3576042263;
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer594adff7df321397626846);
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, '__isset', array('name' => $name), $this->initializer594adff7df321397626846);
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, '__unset', array('name' => $name), $this->initializer594adff7df321397626846);
    ...
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, '__clone', array(), $this->initializer594adff7df321397626846);

        $this->valueHolder594adff7df2f3576042263 = clone $this->valueHolder594adff7df2f3576042263;
    }

    public function __sleep()
    {
        $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, '__sleep', array(), $this->initializer594adff7df321397626846);

        return array('valueHolder594adff7df2f3576042263');
    }
    ...
    {
        return $this->initializer594adff7df321397626846;
    }
    ...
    {
        return $this->initializer594adff7df321397626846 && $this->initializer594adff7df321397626846->__invoke($this->valueHolder594adff7df2f3576042263, $this, 'initializeProxy', array(), $this->initializer594adff7df321397626846);
    }
    ...
    {
        return null !== $this->valueHolder594adff7df2f3576042263;
    }
    ...
    {
        return $this->valueHolder594adff7df2f3576042263;
    }
