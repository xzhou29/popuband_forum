...
class faq extends controller
{
	...
	public function display()
	{
		...
		$this->manager->add_block(
			'HELP_FAQ_BLOCK_HADWARE',
			false,
			array(
				'HELP_FAQ_BLOCK_POPULELE_SMART_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_SMART_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_REAL_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_REAL_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_MATERIAL_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_MATERIAL_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_WEIGHT_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_WEIGHT_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_BATTERY_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_BATTERY_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_CHARGE_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_CHARGE_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_BATTERYLIFE_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_BATTERYLIFE_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_ACCESSORIES_PACKAGE_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_ACCESSORIES_PACKAGE_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_LEDCOLOR_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_LEDCOLOR_ANSWER',
				'HELP_FAQ_BLOCK_POPULELE_BLUETOOTH_SPEAKER_QUESTION' => 'HELP_FAQ_BLOCK_POPULELE_BLUETOOTH_SPEAKER_ANSWER',
			)
		);
		...
		$this->manager->add_block(
			...
			false,
			array(
				'HELP_FAQ_BLOCK_APP_Bluetooth_QUESTION' => 'HELP_FAQ_BLOCK_APP_Bluetooth_ANSWER',
				'HELP_FAQ_BLOCK_APP_recognize_QUESTION' => 'HELP_FAQ_BLOCK_APP_recognize_ANSWER',
				'HELP_FAQ_BLOCK_APP_Playing_QUESTION' => 'HELP_FAQ_BLOCK_APP_Playing_ANSWER',

				'HELP_FAQ_BLOCK_APP_Android_QUESTION' => 'HELP_FAQ_BLOCK_APP_Android_ANSWER',
				'HELP_FAQ_BLOCK_APP_Download_QUESTION' => 'HELP_FAQ_BLOCK_APP_Download_ANSWER',

				'HELP_FAQ_BLOCK_APP_Song_QUESTION' => 'HELP_FAQ_BLOCK_APP_Song_ANSWER',
				'HELP_FAQ_BLOCK_APP_Programmer_QUESTION' => 'HELP_FAQ_BLOCK_APP_Programmer_ANSWER',

				'HELP_FAQ_BLOCK_APP_Dazzle_QUESTION' => 'HELP_FAQ_BLOCK_APP_Dazzle_ANSWER',

			)
		);

		$this->manager->add_block(
			'HELP_FAQ_BLOCK_ORDERS',
			false,
			array(
				'HELP_FAQ_BLOCK_APP_shippingcountry_QUESTION' => 'HELP_FAQ_BLOCK_APP_shippingcountry_ANSWER',
				'HELP_FAQ_BLOCK_APP_receive_QUESTION' => 'HELP_FAQ_BLOCK_APP_receive_ANSWER',
				'HELP_FAQ_BLOCK_APP_indiegogoAP_QUESTION' => 'HELP_FAQ_BLOCK_APP_indiegogoAP_ANSWER',

				'HELP_FAQ_BLOCK_APP_shopifypayment_QUESTION' => 'HELP_FAQ_BLOCK_APP_shopifypayment_ANSWER',
				'HELP_FAQ_BLOCK_APP_forms_QUESTION' => 'HELP_FAQ_BLOCK_APP_forms_ANSWER',
			)
		);


		$this->manager->add_block(
			'HELP_FAQ_BLOCK_WARRANTY',
			false,
			array(
				'HELP_FAQ_BLOCK_APP_warranty_QUESTION' => 'HELP_FAQ_BLOCK_APP_warranty_ANSWER',

				'HELP_FAQ_BLOCK_APP_refundIndiegogo_QUESTION' => 'HELP_FAQ_BLOCK_APP_refundIndiegogo_ANSWER',
				'HELP_FAQ_BLOCK_APP_returnPolicy_QUESTION' => 'HELP_FAQ_BLOCK_APP_returnPolicy_ANSWER',
			)
		);

		$this->manager->add_block(
			'HELP_FAQ_BLOCK_Others',
			false,
			array(
				'HELP_FAQ_BLOCK_APP_version_QUESTION' => 'HELP_FAQ_BLOCK_APP_version_ANSWER',
				'HELP_FAQ_BLOCK_APP_environment_QUESTION' => 'HELP_FAQ_BLOCK_APP_environment_ANSWER',
				'HELP_FAQ_BLOCK_APP_guitarversion_QUESTION' => 'HELP_FAQ_BLOCK_APP_guitarversion_ANSWER',
			)
		);


		$this->manager->add_block(
			'HELP_FAQ_BLOCK_ABOUT_FORUM',
			false,
			array(
				...
				'HELP_FAQ_CONTACT_BOARD_QUESTION' => 'HELP_FAQ_CONTACT_BOARD_ANSWER',
